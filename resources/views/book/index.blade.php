    ...
    <div class="columns">
            ...
            <div class="card">
                ...
                <footer class="card-footer">
                    <div class="card-footer-item">
                        <a href="/book/Oliver" onclick="showBarberAvail()" class="button is-primary is-small is-focused"role="button">Oliver Short</a>
                    </div>
                </footer>
            </div>
        </div>
        <div class="column">
            <div class="card">
                ...
                <footer class="card-footer">
                    <div class="card-footer-item">
                    <a href="/book/Theresa" class="button is-primary is-small is-focused" role="button">Theresa Smith</a>  
                    </div>
                </footer>
            </div>
        </div>
